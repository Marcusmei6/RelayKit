...
Status: build 9 passed short-history switching and explicit compact transport but failed real provider -> official pre-turn remote-compaction-v2; adapter fallback fix implemented, build 10 packaging and reopened-long-thread validation pending.
